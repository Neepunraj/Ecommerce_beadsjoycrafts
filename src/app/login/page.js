...
function Login() {
    ...
    const {
        ...
        user, setUSer, componentLevelLoader, setComponentLevelLoader,
    ...
    return (
        <div className='bg-white relative'>
            <div className='flex flex-col items-center justify-between pt-0 pr-10 pb-0 pl-10 mt-8 mr-auto xl:px-5 lg:flex-row'>
                ...
                text-white transition-all duration-200 ease-in-out focus:shadow font-medium uppercase tracking-wide"> Register
                                    </button>
                                </div>
                            </div>
